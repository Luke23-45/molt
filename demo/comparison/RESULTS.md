...
| -------------- | -------------- | ---------------------------------------------: | -----------------------------: | ------------------------------------------------ | ---------: |
| naive-registry | local baseline |                                             no |                            102 | not available: no dependency graph               |      0.025 |
| cordis         | 4.0.0-rc.9     |                                             no |                              0 | not available: dependency policy is host-defined |     99.782 |
| @molt/runtime  | 0.0.0          |                                            yes |                              0 | ACTIVE_DEPENDENTS:demo.consumer>demo.plugin      |     11.755 |
