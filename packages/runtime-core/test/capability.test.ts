// Capability token tests (plan 03 §1): grammar, policy field, freezing, and
// structural (not identity) equality across factory copies (ADR-05).
...
describe('capability factory', () => {
  ...
  it('rejects ids that violate the grammar (plan 03 §1)', () => {
  ...
  it('structurally equal tokens from separate factory calls are equal but not identical (ADR-05)', () => {
