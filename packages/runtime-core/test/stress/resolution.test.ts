// Resolution budget stress (plan 04 §4): 1,000+ definitions resolve within a
...
// prove the plan is real, not just fast. Deterministic construction: a
...
describe('resolution budget (plan 04 sec 4)', () => {
  it(
    'INV-10: 1,000+ definitions resolve under the 100 ms plan-construction ceiling, deterministically',
    { timeout: 120_000 },
    () => {
