...
```ts
import { capability, createRuntime } from '@molt/runtime';
...
Implemented; packaged but not yet released. The design notes, the engineering
plan, and the full invariant registry (INV-01…INV-15) live in the repository
under `docs/`. See the root README for scope, non-goals, and how Molt compares
