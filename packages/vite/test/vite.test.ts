...
import { capability, createRuntime, isMoltError } from '@molt/runtime';
import { expectGenerationDisposed, fakeResources } from '@molt/test';
...
describe('Vite adapter (P3-3, INV-07)', () => {
