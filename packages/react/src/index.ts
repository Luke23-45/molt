/**
 * React bindings for committed, generation-scoped Molt contributions.
 * @packageDocumentation
 */

import type { ContributionEntry, ContributionKey, Runtime, RuntimeListener } from '@molt/runtime';
...
/**
 * Provides committed Molt contribution snapshots to descendant hooks.
 * @throws Errors thrown by React while rendering the provider are handled by the host tree.
 * @public
 */
